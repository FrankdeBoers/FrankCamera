package com.frank.filters.widget.base;
...
import com.frank.filters.filter.helper.FilterFactory;
...
public abstract class FilterBaseView extends GLSurfaceView implements GLSurfaceView.Renderer {
     ...
     * SurfaceTexure纹理id
     */
    protected int textureId = com.frank.filters.utils.OpenGlUtils.NO_TEXTURE;
    /**
     * GLSurfaceView的宽高
     */
    ...
    public FilterBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
        gLCubeBuffer = ByteBuffer.allocateDirect(com.frank.filters.utils.TextureRotationUtil.CUBE.length * 4)
                .order(ByteOrder.nativeOrder())
                .asFloatBuffer();
        gLCubeBuffer.put(com.frank.filters.utils.TextureRotationUtil.CUBE).position(0);

        gLTextureBuffer = ByteBuffer.allocateDirect(com.frank.filters.utils.TextureRotationUtil.TEXTURE_NO_ROTATION.length * 4)
                .order(ByteOrder.nativeOrder())
                .asFloatBuffer();
        gLTextureBuffer.put(com.frank.filters.utils.TextureRotationUtil.TEXTURE_NO_ROTATION).position(0);
        ...
        if (textureId != com.frank.filters.utils.OpenGlUtils.NO_TEXTURE) {
            queueEvent(new Runnable() {
                ...
                public void run() {
                    ...
                    textureId = com.frank.filters.utils.OpenGlUtils.NO_TEXTURE;
                }
            });
        }
    }
    ...
    protected void adjustSize(int rotation, boolean flipHorizontal, boolean flipVertical) {
        float[] textureCords = com.frank.filters.utils.TextureRotationUtil.getRotation(com.frank.filters.utils.Rotation.fromInt(rotation),
                flipHorizontal, flipVertical);
        float[] cube = com.frank.filters.utils.TextureRotationUtil.CUBE;
        ...
        if (scaleType == ScaleType.CENTER_INSIDE) {
            cube = new float[]{
                    com.frank.filters.utils.TextureRotationUtil.CUBE[0] / ratioHeight, com.frank.filters.utils.TextureRotationUtil.CUBE[1] / ratioWidth,
                    com.frank.filters.utils.TextureRotationUtil.CUBE[2] / ratioHeight, com.frank.filters.utils.TextureRotationUtil.CUBE[3] / ratioWidth,
                    com.frank.filters.utils.TextureRotationUtil.CUBE[4] / ratioHeight, com.frank.filters.utils.TextureRotationUtil.CUBE[5] / ratioWidth,
                    com.frank.filters.utils.TextureRotationUtil.CUBE[6] / ratioHeight, com.frank.filters.utils.TextureRotationUtil.CUBE[7] / ratioWidth,
            };
