package com.xxun.xunfilter.widget.base;
...
import com.xxun.xunfilter.filter.helper.FilterFactory;
...
public abstract class FilterBaseView extends GLSurfaceView implements GLSurfaceView.Renderer {
     ...
     * SurfaceTexure纹理id
     */
    protected int textureId = com.xxun.xunfilter.utils.OpenGlUtils.NO_TEXTURE;
    /**
     * GLSurfaceView的宽高
     */
    ...
    public FilterBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
        gLCubeBuffer = ByteBuffer.allocateDirect(com.xxun.xunfilter.utils.TextureRotationUtil.CUBE.length * 4)
                .order(ByteOrder.nativeOrder())
                .asFloatBuffer();
        gLCubeBuffer.put(com.xxun.xunfilter.utils.TextureRotationUtil.CUBE).position(0);

        gLTextureBuffer = ByteBuffer.allocateDirect(com.xxun.xunfilter.utils.TextureRotationUtil.TEXTURE_NO_ROTATION.length * 4)
                .order(ByteOrder.nativeOrder())
                .asFloatBuffer();
        gLTextureBuffer.put(com.xxun.xunfilter.utils.TextureRotationUtil.TEXTURE_NO_ROTATION).position(0);
        ...
        if (textureId != com.xxun.xunfilter.utils.OpenGlUtils.NO_TEXTURE) {
            queueEvent(new Runnable() {
                ...
                public void run() {
                    ...
                    textureId = com.xxun.xunfilter.utils.OpenGlUtils.NO_TEXTURE;
                }
            });
        }
    }
    ...
    protected void adjustSize(int rotation, boolean flipHorizontal, boolean flipVertical) {
        float[] textureCords = com.xxun.xunfilter.utils.TextureRotationUtil.getRotation(com.xxun.xunfilter.utils.Rotation.fromInt(rotation),
                flipHorizontal, flipVertical);
        float[] cube = com.xxun.xunfilter.utils.TextureRotationUtil.CUBE;
        ...
        if (scaleType == ScaleType.CENTER_INSIDE) {
            cube = new float[]{
                    com.xxun.xunfilter.utils.TextureRotationUtil.CUBE[0] / ratioHeight, com.xxun.xunfilter.utils.TextureRotationUtil.CUBE[1] / ratioWidth,
                    com.xxun.xunfilter.utils.TextureRotationUtil.CUBE[2] / ratioHeight, com.xxun.xunfilter.utils.TextureRotationUtil.CUBE[3] / ratioWidth,
                    com.xxun.xunfilter.utils.TextureRotationUtil.CUBE[4] / ratioHeight, com.xxun.xunfilter.utils.TextureRotationUtil.CUBE[5] / ratioWidth,
                    com.xxun.xunfilter.utils.TextureRotationUtil.CUBE[6] / ratioHeight, com.xxun.xunfilter.utils.TextureRotationUtil.CUBE[7] / ratioWidth,
            };
