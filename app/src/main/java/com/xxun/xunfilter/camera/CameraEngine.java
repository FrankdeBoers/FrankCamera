package com.xxun.xunfilter.camera;
...
import static com.xxun.camera.activity.CameraMainActivity.PREVIEW_SIZE_HEIGHT;
import static com.xxun.camera.activity.CameraMainActivity.PREVIEW_SIZE_WIDTH;
...
//        Size pictureSize = CameraUtils.getLargePictureSize(camera);
    ...
    public static com.xxun.xunfilter.camera.utils.CameraInfo getCameraInfo() {
        com.xxun.xunfilter.camera.utils.CameraInfo info = new com.xxun.xunfilter.camera.utils.CameraInfo();
