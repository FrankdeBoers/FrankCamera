package com.xxun.xunfilter.utils;
    ...
    public static Bitmap drawToBitmapByFilter(Bitmap bitmap, GPUImageFilter filter,
        ...
        if (rotate) {
            ...
            FloatBuffer gLTextureBuffer = ByteBuffer.allocateDirect(com.xxun.xunfilter.utils.TextureRotationUtil.TEXTURE_NO_ROTATION.length * 4)
                    .order(ByteOrder.nativeOrder())
                    .asFloatBuffer();
            gLTextureBuffer.put(com.xxun.xunfilter.utils.TextureRotationUtil.getRotation(Rotation.ROTATION_90, true, false)).position(0);
