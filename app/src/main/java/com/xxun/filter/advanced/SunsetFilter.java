...
public class SunsetFilter extends GPUImageFilter {
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            ...
            public void run() {
                ...
                mMaskGrey1TextureId = OpenGlUtils.loadTexture(FilterParams.context, "filter/rise_mask1.jpg");
                mMaskGrey2TextureId = OpenGlUtils.loadTexture(FilterParams.context, "filter/rise_mask2.jpg");
            }
        });
    }
}
