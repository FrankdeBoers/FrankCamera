...
public class WarmFilter extends GPUImageFilter {
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            ...
            public void run() {
                ...
                mMaskGrey1TextureId = OpenGlUtils.loadTexture(FilterParams.context, "filter/warm_layer1.jpg");
                mMaskGrey2TextureId = OpenGlUtils.loadTexture(FilterParams.context, "filter/bluevintage_mask1.jpg");
            }
        });
    }
}
